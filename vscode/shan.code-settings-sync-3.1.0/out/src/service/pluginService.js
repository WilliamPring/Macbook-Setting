...
class PluginService {
    ...
    static InstallExtensions(extensions, extFolder, useCli, ignoredExtensions, osType, notificationCallBack) {
        return __awaiter(this, void 0, void 0, function* () {
            let actionList = [];
            let addedExtensions = [];
            ...
            if (useCli) {
                addedExtensions = yield PluginService.ProcessInstallationCLI(missingList, osType, notificationCallBack);
    ...
    static ProcessInstallationCLI(missingList, osType, notificationCallBack) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (osType === enums_1.OsType.Linux) {
                codeLastFolder = "code";
            }
            if (osType === enums_1.OsType.Mac) {
